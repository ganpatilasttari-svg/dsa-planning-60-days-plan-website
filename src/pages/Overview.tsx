    ...
    <>
      ...
      <div className="content-area">
        ...
        <div className="card animate-fadeIn mb-6">
          <div className="section-title"><Target size={18} style={{ color: '#ffffff' }} /> All 55 Days — Click to View Schedule</div>
        ...
        <div className="card animate-fadeIn">
          <div className="section-title"><Zap size={18} style={{ color: '#a0a0a0' }} /> Detailed Schedule</div>
              ...
              return (
                <div key={day.dayNumber} className="question-item" style={{ cursor: 'pointer' }} onClick={() => navigate(`/day/${day.dayNumber}`)}>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '13px', fontWeight: 700, color: solved > 0 ? '#e8e8e8' : 'var(--text-tertiary)' }}>{solved}/{day.questions.length}</div>
